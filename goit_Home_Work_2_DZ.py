...
except ZeroDivisionError :  # оператор *expect спрацьовує коли виникла поилка в тілі коду *try . *expect може бути без параметру (тоді спрацьовує на будь яку помилку ) або вказувати параметром (яка саме помилка має бути опрцьована) Так можна різні помилки опрацьовувати по різному. 
