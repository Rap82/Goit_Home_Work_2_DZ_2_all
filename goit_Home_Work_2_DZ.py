...
# Використовується якщо наперед невідомо скількі раз потрібно виконувати код який розміщений в тілі циклу (все що зміщено більше ніж на 4 пробіли/tab від початку запису while) 
